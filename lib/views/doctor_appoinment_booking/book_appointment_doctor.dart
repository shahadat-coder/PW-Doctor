              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15),
                    ArivableRow(title: 'Reviews',onTap: (){},),
                    const SizedBox(height: 10),
                      Card(
                          elevation: 0,
                        ...
                        child: Padding(
                          ...
                          children: [
                            Row(
                              children: [
                                const CircleAvatar(
                                  backgroundImage: NetworkImage('https://storage.googleapis.com/pai-images/1ebdd59610d6401c93e138bc2d41592f.jpeg'),
                                ),
                            ...
                            const Row(
                                children: [
                                Icon(Icons.favorite_border, color: AppColors.primaryColors, size: 15),
                            SizedBox(width: 5),
                            Text(
                              "938",
